public class ArrayFromScratch {
    public static class MyArray {
        ...
        public String toString() {
            ...
            for (int i = 0; i < currentIndex; i++) { // Iterate up to the current index to include only inserted
                                                     // elements
                str.append(array[i]); // Append the current element to the string
                if (i < currentIndex - 1) { // Check if the current element is not the last one
